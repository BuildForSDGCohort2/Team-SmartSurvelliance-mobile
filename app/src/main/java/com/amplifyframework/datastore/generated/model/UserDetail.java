...
public final class UserDetail implements Model {
  ...
  private UserDetail(String id, String userId, List<String> fcmRegistrationId) {
    this.id = id;
    this.userId = userId;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), userDetail.getId()) &&
              ObjectsCompat.equals(getUserId(), userDetail.getUserId()) &&
              ObjectsCompat.equals(getFcmRegistrationId(), userDetail.getFcmRegistrationId());
      }
  }
   ...
   */
  public static UserDetail justId(String id) {
    try {
